<template>
  <div v-if="visible"
       class="custom-alert-wrapper d-flex align-items-center justify-content-center w-100 position-fixed z-3">
    <div
        class="custom-alert p-3 rounded-bottom border border-dark-subtle d-flex align-items-center justify-content-center gap-3 position-relative bg-white">
